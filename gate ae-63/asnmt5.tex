...
\begin{align}
    I\alpha\brak{t}\brak{t}&= k\brak{x-\frac{L\theta\brak{t}}{2}}\frac{L}{2}-k\brak{x+\frac{L\theta\brak{t}}{2}}\frac{L}{2}\\
    I\alpha\brak{t}&=-\frac{kL^2\theta\brak{t}}{2}
\end{align}
Assuming it is at mean position and having no zero angular velocity
we can write it's laplace transform as:
    \begin{align}
        s^2I\Theta\brak{s}-\omega_o+ \frac{kL^2\theta\brak{t}\brak{s}}{2}&=0
    \end{align}
    substituting values from \tabref{tab: Table ae63}:
    \begin{align}
        \Theta\brak{s}&=\frac{\frac{12\omega_o}{m}}{s^2+\frac{6k}{m}}
    \end{align}
    On taking inverse laplace transform we get,
    \begin{align}
        \theta\brak{t} &= \omega_o\sqrt{\frac{24}{mk}}\cos{\sqrt{\frac{6k}{m}}t}\\
