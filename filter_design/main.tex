...
we get $N\geq 4$ and $0.28 \leq \epsilon \leq 0.616$\\
\newpage
...
\caption{The Analog Low-Pass Frequency Response for $0.28  \leq \epsilon \leq 0.61$}
...
\begin{align}
    H_{a,BP}\brak{s} &= \frac{2.54\times 10^{-5}s^4}{s^8 + 0.115s^7 + 0.53s^6 + 0.045s^5 + 0.103s^4 + 0.005s^3 + 0.008s^2 + 0.0002s + 0.00027} \label{eq:magnitude_bandpass_sdom}
\end{align}
...
\begin{align}
    H_{d,BP}(z) &= \frac{14\times10^{-6}(1-4z^6+8z^4-4z^2+1)}{z^8 - 6z^7 + 17.293z^6 - 30.537z^5 + 36.065z^4 - 29z^3 + 15.60z^2 - 5.14z + 0.8163}
\end{align} 
\begin{figure}[H]
\centering
